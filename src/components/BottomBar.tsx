...
export default function BottomBar() {
  ...
  const [trayOwner, setTrayOwner] = useState<Side | null>(null);
  if (!state) return null;
  const hand = state.playerHands[state.activeSide];
  const trayOpen = trayOwner === state.activeSide;
